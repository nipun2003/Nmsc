...
import com.nipunapps.nmsc.exoplayer.MusicServiceConnection
...
object AppModule {
    ...
    fun provideGlideInstance(
        ...
        RequestOptions().placeholder(R.drawable.ic_image).error(R.drawable.ic_image).diskCacheStrategy(
